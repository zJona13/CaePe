...
export default function JoinGroup() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        const member = await joinGroup.mutateAsync(code);
        if (!cancelled) router.replace({ pathname: '/groups/[id]', params: { id: member.group_id } });
      } catch (e) {
    ...
    return (
      <SafeAreaView style={styles.container} edges={['top', 'bottom']}>
        ...
        <View style={styles.body}>
          <Text style={styles.title}>Únete al grupo</Text>
          <Text style={styles.subtitle}>Inicia sesión o crea tu cuenta para unirte automáticamente al grupo.</Text>
      ...
      <View style={styles.body}>
        {error ? (
          ...
          <>
            ...
            <Text style={styles.subtitle}>Uniéndote al grupo...</Text>
          </>
        )}
      </View>
    </SafeAreaView>
